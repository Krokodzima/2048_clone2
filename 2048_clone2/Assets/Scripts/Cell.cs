...
public class Cell : MonoBehaviour
{
    ...
    {
        CellAnimationController.Instance.SmoothTransition(this, otherCell, true); // вызов анимации (откуда, куда, объедин€емс€ ли)
    ...
    {
        CellAnimationController.Instance.SmoothTransition(this, target, false); // вызов анимации (откуда, куда, объедин€емс€ ли)
