...
public class Field : MonoBehaviour
{
    ...
    [Space(5)]
    public Color LowValueColor;// переменная для цвета шрифта значения ячейки
   ...
   void Start()  // 2 00:57 - ошибка создания лишних ячеек
    {
    ...
    private void GenerateRandomeCell() // метод генерации рандомной ячейки
    {
        ...
        cell.SetValue(cell.X, cell.Y, value, false); // присвоить ячейке cell координаты и значение 
